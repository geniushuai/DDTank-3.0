...
namespace Phy.Object
{
    public class Player : Physics
    {
        ...
        public void Reset()
        {
            ...
            _maxBlood = 950 + _player.PlayerCharacter.Grade * 50;
            _blood = _maxBlood;
            TotalHurt = 0;
            TotalKill = 0;
            HitNum = 0;
            ...
            : base(player.PlayerCharacter.ID)
        {
            ...
            _player = player;
            _maxBlood = 950 + player.PlayerCharacter.Grade * 50;
            _blood = _maxBlood;
            //Reset();
        }
        ...
        public override void SetXY(int x, int y)
        {
            ...
            if (_energy < -20)
            {
                ...
                //GameServer.log.Error("oldX:" + _x + ",oldY:" + _y);
                //GameServer.log.Error("X:" + x + ",Y:" + y);
        ...
        public void KillBy(Player bombOwner, int x, int y, double power)
        {
            ...
            int lostHeath = (int)(data.CurrentBall.Power * AttackPlayer.BaseAttack * (1 + (double)AttackPlayer.PlayerCharacter.Attack * 0.001) * (1 - (double)_player.BaseDefence / 200 - (double)_player.PlayerCharacter.Defence * 0.0003) * (1 + AttackPlayer.CurrentGame.Data.AddWound));
