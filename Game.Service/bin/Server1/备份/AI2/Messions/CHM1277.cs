...
namespace GameServerScript.AI.Messions
{
    public class CHM1277 : AMissionControl
    {
        ...
        private static string[] dialogue = new string[]{ "啊~~我的头好痛……为什么我会在这里！？",
            "炸弹王马迪亚斯呢？………..我记起来了。" ,
        "感谢你们高贵的勇士，我是啵咕国王尼尔鲁奥要不",
        "是有你们的帮助，我可能永远也无法摆脱马迪亚斯" ,
        "的控制。",
        "几年前炸弹人向啵咕国发动战争，在一次战斗中我",
        "不小心中了炸弹王马迪亚斯的诡计被他用精神枷锁",
        "诅咒控制。在刚刚和你们的战斗中他的诅咒被破坏，",
        "才让我重获自由！ 时间不多了他也肯定感知到诅" ,
        "咒的消失，可能正赶往这里！马迪亚斯非常强大，" , 
        "现在的我非常虚弱可能抵挡不了多久，在他赶来之",
        "前请你们赶快离开这里！"};
